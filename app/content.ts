...
export const DEFAULT_TEXTS: Record<string, string> = {
  ...
  /* ---- 松竹の仕事（技術の説明）。検索から来た方が「何ができる店か」を読める文章 ---- */
  "craft.kicker": "できることを、正直に。",
  "craft.title1": "松竹の",
  "craft.title2": "得意な仕事。",
  "craft.lead": "青梅市東青梅の理容室・松竹では、フェードカットを軸に、濡れパン、アイロンパーマ、パンチパーマ、そしてシェービングまで、床屋の技をひと通り承っています。同じ名前の技術でも、骨格・髪質・お仕事の決まりごと・ふだん手入れにかけられる時間で、加減はまるで変わります。以下は、松竹でよくご依頼いただく仕事です。",
  "craft.1.name": "フェードカット",
  "craft.1.body": "襟足やもみあげからトップへ向かって、刈り上げの長さを段なく繋いでいく刈り方です。境目を残さず溶かし込むほど、頭の形が整って見えます。どの高さから繋ぐかを、お顔立ちと骨格に合わせて決めています。",
  "craft.2.name": "スキンフェード",
  "craft.2.body": "刈り上げの一番下を地肌の色まで落とす、フェードの中でもっとも短い仕上げです。輪郭がはっきり出るぶん、伸びてきたときの見え方まで考えて高さを決めます。0.4mm以下の短さもご相談ください。",
  "craft.3.name": "濡れパン",
  "craft.3.body": "濡れたような艶と、流れる毛先をつくるパーマです。松竹の看板と言える仕事で、フェードと合わせると、短い部分の清潔感とトップの動きが同時に出ます。",
  "craft.4.name": "アイロンパーマ・アイパー",
  "craft.4.body": "熱したアイロンで毛の流れをつくるパーマです。ロッドでは出せない直線的な流れと、朝の手入れの楽さが持ち味。くせ毛を落ち着かせたい方にも向きます。",
  "craft.5.name": "パンチパーマ・ニグロパーマ",
  "craft.5.body": "強く締まったカールで頭の形をきりっと見せる、床屋の伝統的な技術です。フェードと組み合わせて、以前より柔らかな仕上がりにすることもできます。",
  "craft.6.name": "シェービング",
  "craft.6.body": "カットにはシャンプー・シェービング・ブローが含まれています。顔まわりと襟足を刃で整えると輪郭の線がはっきりし、同じ髪型でも仕上がりの印象が変わります。",

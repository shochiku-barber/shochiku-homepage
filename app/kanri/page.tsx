...
const SECTIONS: { title: string; note?: string; fields: [string, string, ("line" | "area")?][] }[] = [
  ...
  {
    title: "松竹の仕事（技術の説明）",
    note: "検索から来た方が「何ができるお店か」を読むところです。空にすると見出しが消えます。",
    fields: [
      ["craft.kicker", "小見出し"],
      ["craft.title1", "見出し（1行目）"],
      ["craft.title2", "見出し（2行目）"],
      ["craft.lead", "はじめの文章", "area"],
      ["craft.1.name", "1つ目・名前"],
      ["craft.1.body", "1つ目・説明", "area"],
      ["craft.2.name", "2つ目・名前"],
      ["craft.2.body", "2つ目・説明", "area"],
      ["craft.3.name", "3つ目・名前"],
      ["craft.3.body", "3つ目・説明", "area"],
      ["craft.4.name", "4つ目・名前"],
      ["craft.4.body", "4つ目・説明", "area"],
      ["craft.5.name", "5つ目・名前"],
      ["craft.5.body", "5つ目・説明", "area"],
      ["craft.6.name", "6つ目・名前"],
      ["craft.6.body", "6つ目・説明", "area"],
    ],
  },
  {
    title: "よくあるご質問",
    note: "質問と答えを両方書いたものだけがサイトに出ます。片方でも空にすれば、その一問は出ません。",
    fields: [
      ["faq.kicker", "小見出し"],
      ["faq.title1", "見出し（1行目）"],
      ["faq.title2", "見出し（2行目）"],
